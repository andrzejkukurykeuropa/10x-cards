...
|---|---|---|---|---|---|---|
| 1 | Auth and access-control coverage | Obrona integralności logowania/sesji i izolacji danych per użytkownik na najtańszej warstwie | #1, #3 | integracyjne | change opened | `context/changes/testing-auth-access-control/` |
